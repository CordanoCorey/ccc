import { Component, OnInit, HostListener, ElementRef, Input, ChangeDetectionStrategy } from '@angular/core';

import { Image } from '../models';
import { toPx, buildEmptyCells, integerArray } from '../utils';

@Component({
  selector: 'ccc-wallpaper',
