...
export class ContainerComponent implements OnInit {
  ...
  images = [
    build(Image, { src: 'assets/v/1.jpg', height: 1641, width: 2048, cols: 2, color: '#000', name: 'billy-o' }),
    build(Image, { src: 'assets/v/7.jpg', height: 569, width: 500, cols: 3, name: 'hamilton-restaurant' }),
    build(Image, { src: 'assets/h/2.jpg', height: 305, width: 452, cols: 2, name: 'carlisle-borough-sign' }),
    build(Image, { src: 'assets/h/12.jpg', height: 366, width: 650, cols: 2, name: 'carlisle-police' }),
    build(Image, { src: 'assets/h/1.jpg', height: 655, width: 1600, cols: 3, name: 'proudly-serving' }),

    build(Image, { src: 'assets/v/5.jpg', height: 503, width: 450, cols: 2 }),
    build(Image, { src: 'assets/v/10.jpg', height: 1536, width: 2048, cols: 3, name: 'bison' }),
    build(Image, { src: 'assets/h/3.jpg', height: 640, width: 1280, cols: 2, color: 'darkgreen', name: 'andrew-marshall-squad' }),
    build(Image, { src: 'assets/h/6.jpg', height: 215, width: 350, cols: 2, color: '#000', name: 'street-hoops' }),
    build(Image, { src: 'assets/v/2.jpg', height: 1344, width: 1200, cols: 2, name: 'powder' }),
    ...
    build(Image, { src: 'assets/h/16.jpg', height: 701, width: 1024, cols: 2, name: 'dickinson' }),
